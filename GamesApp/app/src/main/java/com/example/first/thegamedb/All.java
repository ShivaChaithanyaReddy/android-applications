...
public class All extends AppCompatActivity implements GetGameAsync.IGame{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameSelected = getIntent().getExtras().getString(SimilarGamesA.GAME);
    ...
    public void sendGame(ArrayList<GetGame> games) {
        ...
        if(games != null)
        {
            ...
            if(game.getImage() != null) {
                new IAsync(this).execute(games.get(0).getImage());
            }
            else {
    ...
    public void onClickS(View view) {
        ...
        if(arrayList !=null) {
            ...
            Intent intent = new Intent(All.this, SimilarGamesA.class);
