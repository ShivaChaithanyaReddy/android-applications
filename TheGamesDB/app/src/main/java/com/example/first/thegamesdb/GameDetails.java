...
public class GameDetails extends AppCompatActivity implements GetGameAsync.IGame{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameSelected = getIntent().getExtras().getInt(MainActivity.GAME);
        ...
        trailer = (Button) findViewById(R.id.playtrailerBtn);
        ...
        new GetGameAsync(this).execute("http://thegamesdb.net/api/GetGame.php?id="+gameSelected);
    ...
    public void onClickT(View view) {
        ...
        if(receivedGameDetails.get(0).getTrailer() == null)
            Toast.makeText(this,"No Trailer found!",Toast.LENGTH_SHORT).show();
        else {
            Intent intent = new Intent(GameDetails.this, Trailer.class);
            intent.putExtra(TRAILER, receivedGameDetails.get(0).getTrailer());
