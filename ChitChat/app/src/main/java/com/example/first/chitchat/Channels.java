...
public class Channels {
    ...
    public static class ChannelBean {
        ...
        private SingleChannelBean channel;


        public SingleChannelBean getChannel() {
            return channel;
        }

        public void setChannel(SingleChannelBean channel) {
        ...
        public static class SingleChannelBean {
